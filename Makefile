...
dist:
	...
	CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o ${HELM_PLUGIN_NAME} -ldflags $(LDFLAGS) ./cmd
	tar -zcvf $(DIST)/${HELM_PLUGIN_NAME}-macos-arm.tgz ${HELM_PLUGIN_NAME} README.md LICENSE plugin.yaml
